 ...
 * <dt>0.5</dt>
 * <dd>Remove some commentary and reformat</dd>
 * </dl>
 *
 * <h4>Todo</h4>
 * <ul>
...
public class BCDNumeral extends Number implements Comparable < BCDNumeral >
{
    ...
    {
        /**
         * Pads with 0xFF to the Right
         */
        LEFT,

        /**
         * Pads with 0x00 to the Left
         */
        RIGHT
    }

    static final int  SIZE_NIBBLE = 4;
    static final byte MASK_LEFT   = 0xF;
    static final byte MASK_RIGHT  = (byte) 0xF0;
    static final byte PAD_RIGHT   = (byte) 0xFF;
    static final byte ZERO        = 0x0;

    /**
     * Compress BCD Byte Array
     *
     * @param in
     *            Uncompressed BCD Byte Array to Compress
    ...
    static Byte[] ConvertPrimitiveArray(byte[] in)
    {
     ...
     * @return BCDNumeral
     */
    public static BCDNumeral fromHexString(String s, boolean compressed, Justification j)
    {
     ...
     */
    public static Byte[] IntegerToBCDNArray(long i, boolean compress, Justification j, int length)
    {

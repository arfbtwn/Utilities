 ...
 *
 */
public class BindingImpl implements Binding2 {
    ...
    private BindingEventSource events;
     ...
     */
    public BindingImpl(Object src, Object dst, 
    ...
    public TypeConverter getConverter() { return converter; }
    
    public void setConverter(TypeConverter x) { converter = x; }
